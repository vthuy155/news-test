...
const Banner = (props: Props) => {
    return (
        <div className='mx-8 mt-8 mb-8'>
            <Link rel="noopener noreferrer" to={`/suctre70`} className="block max-w-sm gap-3 mx-auto sm:max-w-full hover:no-underline focus:no-underline lg:grid lg:grid-cols-12">
